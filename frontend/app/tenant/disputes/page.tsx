  ...
  if (!isAuthenticated || user?.role !== 'tenant') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[400px] text-center p-8">
        ...
        <p className="text-blue-200/50 mb-6">Disputes are only available to verified tenants.</p>
        <Link href="/" className="px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-sm font-semibold transition-colors">
          Connect Wallet
        </Link>
      </div>
    );
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-white tracking-tight">Disputes</h1>
          <p className="text-blue-200/50 mt-1">Manage all your rental disputes.</p>
        </div>
        <Link
